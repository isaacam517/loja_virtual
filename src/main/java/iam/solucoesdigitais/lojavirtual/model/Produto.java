...
public class Produto implements Serializable{
	...
	private Boolean alertaQtdDeEstoque = Boolean.FALSE;
	...
	public Boolean getAlertaQtdDeEstoque() {
		return alertaQtdDeEstoque;
	}

	public void setAlertaQtdDeEstoque(Boolean alertaQtdDeEstoque) {
		this.alertaQtdDeEstoque = alertaQtdDeEstoque;
	}
